...
# define MAX_CODERS_PER_DONGLE 3
...
{
	short			counter;
	long long		order[MAX_CODERS_PER_DONGLE];
...
void		init_sim_fields(t_simulation *sim, t_coder *coders,
				t_dongle *dongles, t_arguments data);

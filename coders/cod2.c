...
/*   Updated: 2026/06/04 16:25:16 by brouane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     while ((!s_phase && get_coders_passed(dongle) == 2 && get_counter(dongle) < 2) || (s_phase && get_coders_passed(dongle) == 2 && get_counter(dongle) < 2))
//         ;
...
// void edf_wait_turn(t_dongle *d, long long my_deadline, t_simulation *sim)
// {
//     while (1)
//     {
//         pthread_mutex_lock(&d->scheduler.counter_mtx);

//         if (d->scheduler.counter == 0)
//         {
//             pthread_mutex_unlock(&d->scheduler.counter_mtx);
//             return;
//         }

//         if (d->coders_passed == d->scheduler.counter && d->scheduler.counter != 0)
//         {
